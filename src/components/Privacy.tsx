      ...
      <section className="max-w-4xl mx-auto px-6 pt-12 pb-32">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 bg-blue-500/10 rounded-xl"><Shield className="w-5 h-5 text-blue-500" /></div>
            <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">{t('privacy.last_updated')}: {lastUpdated}</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 font-display text-white">{t('privacy.title')}</h1>
          <p className="text-lg text-zinc-500 leading-relaxed">{t('privacy.intro')}</p>
        </motion.div>
